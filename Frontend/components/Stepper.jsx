...
export default function Stepper({
  ...
  // Keyboard navigation with edge case prevention
  React.useEffect(() => {
    const handleKeyDown = (e) => {
      if (e.key === 'ArrowRight') {
        e.preventDefault();
        // Prevent navigation if completed or at last step (user must click Complete button)
        if (isCompleted || isLastStep) return;
        handleNext();
      } else if (e.key === 'ArrowLeft') {
        e.preventDefault();
        // Prevent navigation if at first step or completed
  ...
  }, [currentStep, isLastStep, isCompleted]);
