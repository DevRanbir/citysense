          ...
          >
            ...
            <Step>
              <div>
                ...
                <p className="text-gray-600 mb-6">We'd love to know who you are!</p>
            ...
            <Step>
              <div>
                ...
                <p className="text-gray-600 mb-6">How would you like to receive updates?</p>
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-12 px-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-lime-400 focus:border-transparent outline-none"
                    />
                    <p className="text-xs text-gray-500 mt-1">We'll use this for important alerts and notifications</p>
                  </div>
                  
                  <div className="space-y-4">
                    <div className="bg-white border border-gray-200 rounded-xl p-4 hover:border-lime-300 transition-all">
                      <label className="flex items-start cursor-pointer">
                        ...
                        />
                        <div className="ml-3">
                          <span className="block font-medium text-gray-900">Newsletter Subscription</span>
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-4 hover:border-lime-300 transition-all">
                      <label className="flex items-start cursor-pointer">
                        ...
                        />
                        <div className="ml-3">
                          <span className="block font-medium text-gray-900">Real-time Alerts</span>
                          <span className="block text-sm text-gray-600 mt-1">
            ...
            <Step>
              <div>
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600">Review your details before continuing</p>
                </div>
                  ...
                  <div className="space-y-2.5">
                      ...
                      <div className="pt-1.5 border-t border-gray-100">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {interests.map((interest) => (
                            <span key={interest} className="px-2.5 py-1 bg-lime-50 text-lime-700 rounded-md text-xs font-medium">
                              {interest}
                            </span>
                          ))}
                        </div>
                    ...
                    <div className="pt-1.5 border-t border-gray-100">
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <span className={wantsNewsletter ? 'text-green-700 font-medium' : 'text-gray-500'}>
                          {wantsNewsletter ? '✓' : '✗'}
                        </span>
                      </div>
                      <div className="flex items-center justify-between text-xs mt-2">
                        <span className="text-gray-600">Alerts</span>
                        <span className={wantsAlerts ? 'text-green-700 font-medium' : 'text-gray-500'}>
                          {wantsAlerts ? '✓' : '✗'}
                        </span>
                      </div>
                    </div>
